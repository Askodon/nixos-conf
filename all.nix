...

{
  dconf.settings = {
    ...
    "org/gtk/settings/color-chooser" = {
      custom-colors = [ (mkTuple [ 9.019607843137256e-2 7.84313725490196e-2 0.12941176470588237 1.0 ]) (mkTuple [ 9.019607843137255e-2 7.84313725490196e-2 0.12941176470588237 1.0 ]) (mkTuple [ 0.12941176470588237 0.13725490196078433 0.16862745098039217 1.0 ]) (mkTuple [ 0.26666666666666666 0.8352941176470589 0.5607843137254902 1.0 ]) (mkTuple [ 1.0 0.0 0.0 1.0 ]) (mkTuple [ 0.0 1.0 1.0 1.0 ]) (mkTuple [ 0.0 0.8 1.0 1.0 ]) (mkTuple [ 0.0 0.3137254901960784 1.0 1.0 ]) ];
      selected-color = mkTuple [ true 9.019607843137256e-2 7.84313725490196e-2 0.12941176470588237 1.0 ];
    };
    ...
    "org/gtk/settings/file-chooser" = {
      ...
      sort-order = "ascending";
      type-format = "category";
      window-position = mkTuple [ 449 131 ];
