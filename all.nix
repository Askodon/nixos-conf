...

{
  dconf.settings = {
    ...
    "org/cinnamon/desktop/background" = {
      picture-uri = "file:///home/askodon/wallpaper/everforest-themed-nixos-wallpaper-i-made-which-isnt-literal-v0-ii7dzqcin07b1.png";
    };
    ...
    "org/gnome/libgnomekbd/keyboard" = {
      options = [ "grptgrp:win_space_toggle" "grptgrp:win_space_toggle" ];
    };
    ...
    "org/gtk/settings/file-chooser" = {
      ...
      sort-order = "ascending";
      type-format = "category";
      window-position = mkTuple [ 356 110 ];
